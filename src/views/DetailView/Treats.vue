  ...
  export default {
    data() {
      return {
        items: [
          {
            name: "5 Grilled Nuggets",
            price: 10.29,
            image:
              "https://www.cfacdn.com/img/order/menu/Online/Entrees/Dec2019_CFANuggets_5ct_pdp.png",
            rank: "",
            quantity: 0,
          },
          {
            ...
            price: 8.55,
            image:
              "https://www.cfacdn.com/img/order/menu/Online/Entrees/Dec2019_GrilledNuggets_5ct_pdp.png",
            rank: "",
            quantity: 0,
          },
          {
            name: "Grilled Nuggets Special",
            price: 14.55,
            image:
              "https://www.cfacdn.com/img/order/menu/Online/Entrees/strips_2ct_PDP.png",
            rank: "",
            quantity: 0,
          },
        //   {
